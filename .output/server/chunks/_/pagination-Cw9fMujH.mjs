...
import { b as Route$3, u as useQueryClient, L as Link } from './ssr.mjs';
...
const SplitComponent = function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-4 mt-4", children: [
      /* @__PURE__ */ jsx(Link, { to: "/pagination", preload: "intent", className: buttonVariants({
        variant: "outline",
        className: cn(!previousOffset && "opacity-50 cursor-not-allowed")
      }), search: {
        offset: Number(previousOffset)
      }, disabled: !previousOffset, children: "Previous" }),
      /* @__PURE__ */ jsx(Link, { to: "/pagination", preload: "intent", search: {
        offset: Number(nextOffset)
...
//# sourceMappingURL=pagination-Cw9fMujH.mjs.map
