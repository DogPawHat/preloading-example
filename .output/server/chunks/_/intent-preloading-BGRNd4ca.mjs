...
import { c as Route$2, L as Link } from './ssr.mjs';
...
const SplitComponent = function RouteComponent() {
  ...
  const {
    data
  } = useSuspenseQuery(pokemonListOptions);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-4 mt-4", children: [
      /* @__PURE__ */ jsx(Link, { to: "/intent-preloading", preload: "intent", className: buttonVariants({
        variant: "outline",
      ...
      /* @__PURE__ */ jsx(Link, { to: "/intent-preloading", preload: "intent", search: {
...
//# sourceMappingURL=intent-preloading-BGRNd4ca.mjs.map
