...
import { a as Route$4, L as Link } from './ssr.mjs';
...
const SplitComponent = function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-4 mt-4", children: [
      /* @__PURE__ */ jsx(Link, { to: "/preloading", className: buttonVariants({
        variant: "outline",
      ...
      /* @__PURE__ */ jsx(Link, { to: "/preloading", search: {
...
//# sourceMappingURL=preloading-D-Pu2kHV.mjs.map
